// ==UserScript==
// @name         TOAST: WebSockets - client 1 - specified shape
...
function runTest(){
    for (var a = 1; a < 1001; a++){
        ...
        var shapeBtn = document.getElementById("opt1").dispatchEvent(new MouseEvent('click', { //id: opt1 = lines, opt2 = squares, opt3 = circles
            view: window,
            bubbles: true,
            cancelable: true
        }));
        ...
        mouseUpSimulation(1, startCoordinates, endCoordinates, hexCodeFill, hexCodeStroke, lineWidth, a); //param 1: 1 = lines, 2 = squares, 3 = circles
    };
}
